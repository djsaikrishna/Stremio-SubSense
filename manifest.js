...
function generateDescription(config = {}) {
    if (!config.languages || config.languages.length === 0) {
        return 'Subtitle aggregator that fetches subtitles in your selected languages from multiple sources including OpenSubtitles, SubDL, SubSource, AnimeTosho and more.';
    }
